...
function VESTIGE_NIGHTCREAM_BLOGS() {
    return (
        <div>
            <Header />
            <div class="header">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="main-img">
                        <img src="assets/images/blog-details-img20.jpg" alt="Image"/>
                    </div>
                    <div class="part-txt">
                        <div class="title-box">
                            <h2 class="blog-title">Vestige Assure Anti Ageing Night Cream</h2>
                        </div>
                        
                        <p>Night is the best time to treat skin and repair concerns such as Water Loss,Skin Ageing,Dark Spots
                            </p> 
                    </div>
                            <div class="part-txt"> 
...
export default VESTIGE_NIGHTCREAM_BLOGS