                            ...
                            <div class="slider-area">
                                <div class="slide-1">
                                    <div class="banner-txt">
                                        ...
                                        <a href="/vestigeneem" class="def-btn">buy now</a>
                                    </div>
                                </div>
                                <div class="slide-2">
                                    <div class="banner-txt">
                                        <h6></h6>
                                        <h1>DEWGARDEN SANITARY <br></br> NAPKIN</h1>
                                        <p></p>
                                        <div class="price"><span></span> <span></span></div>
                                        <a href="/sanitarynapkin" class="def-btn">buy now</a>
                                    </div>
                                </div>
                                <div class="slide-3">
                                    <div class="banner-txt">
                                        ...
                                        <p></p>
                                        <div class="price"><span></span> <span></span></div>
                                        <a href="/zetacoffee" class="def-btn">buy now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
