...
function HYPERPIGMENTATION_BLOG() {
    return (
        <div>
            <Header />
            <div class="header">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="main-img">
                        <img src="assets/images/blog-details-img2.jpg" alt="Image"/>
                    </div>
                    <div class="part-txt">
                        <div class="title-box">
                            <ul class="blog-info">
                    ...
                    <div class="part-txt">
                        <h3 class="secondary-title">What is Hyperpigmentation?</h3>
                        <p>Hyperpigmentation is a common condition that make some areas of the skin darker than others. Skin gets its color from a substance called melanin which is made by skin cells. When this skin cells are damaged or unhealthy, they can produce too much melanin. The melanin can clump, causing that area to appear darker. Extra melanin creates spots or patches that look brown, black, etc. The areas are not painful or itchy, but they can make people self consious. The spots are sometimes called age spots, sun spots or liver spots.</p>
                    </div>
                    ...
                    <div class="part-txt">
                        ...
                        <p>Many things can lead to hyperpigmentation  : <br></br>
                            ...
                            Friction,<br></br>
                            Melasma,<br></br>
                            When the body doesn't make enough of a hormone called cortisol,<br></br>
                            Hormonal changes, such as during puberty or pregnancy,<br></br>
                            Medications, such as birth control pills and drugs that cause sensitivity to light,<br></br>
                            Sun damage,<br></br>
                            Thyroid Disorders,<br></br>
                            Not getting enough of certain vitamins, such as B12 and folic acid,<br></br>
                            Frickles.</p>
                    </div>
...
export default HYPERPIGMENTATION_BLOG